...
<html>
  <head>
    <title>PA: Edycja artykułu</title>
      ...
      <div class="row">
          <div class="col-md-12 panel-warning">
            <div class="content-box-header panel-heading">
              <div class="panel-title ">Czy aby na pewno?</div>
            </div>
            <div class="content-box-large box-with-header">
              Czy na pewno chcesz usunąć artykuł <b><?php echo $article[1]; ?></b>?<br><br>
              <?php echo form_open(); ?>
              <input type="hidden" name="id" value="<?php echo $article[0]; ?>">
              <button class="btn btn-info"><i class="glyphicon glyphicon-remove"></i> Usuń artykuł</button><br><br>
              <a href=".">Nie. Chcę wrócić.</a>
              </form>
          </div>
          </div>
        </div>
